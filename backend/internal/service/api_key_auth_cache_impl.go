...
const apiKeyAuthSnapshotVersion = 20 // v20: hourly/profit controls plus group long-context and model/media pricing fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			HourlyLimitUSD:                  apiKey.Group.HourlyLimitUSD,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			HourlyLimitUSD:                  snapshot.Group.HourlyLimitUSD,
