...
type HourlyUserSubscriptionRepository interface {
	ActivateWindowsWithHourly(ctx context.Context, id int64, hourlyStart, dailyStart, periodicStart time.Time) error
	ResetUsageWindowsWithHourly(ctx context.Context, id int64, resetHourly, resetDaily, resetWeekly, resetMonthly bool, hourlyStart, dailyStart, periodicStart time.Time) error
