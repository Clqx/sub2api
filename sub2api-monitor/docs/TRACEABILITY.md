...
| SEC-01 | Security Boundary | target and notification secrets, SSRF, audit | SEC-SEC-01 | 1-3 | implemented and locally verified for encryption, redaction, DNS pinning, size bounds, secret files, destination allowlists, read-only transactions, and DB-role rejection; dependency/SBOM/container/secret scans remain release-gated |
